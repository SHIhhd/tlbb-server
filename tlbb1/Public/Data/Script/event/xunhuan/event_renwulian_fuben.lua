...
x229023_g_TitleOfMonster = {"家丁","小侍卫","小喽啰","小跟班","帮凶","随从","弟子","小护卫","门人","家将"}
...
function x229023_MakeCopyScene( sceneId, selfId, nearmembercount )
	...
	LuaFnSetSceneLoad_Map( sceneId, "shiji.path" )						--地图是必须选取的，而且必须在Config/SceneInfo.ini里配置好
...
function x229023_CreateMonster(sceneId)
	...
	for i=1, demandMonsterCount-1 do
		...
		--11环~20环，三项值*1.1
		elseif currRound >= 11 and currRound <= 20 then
			x229023_RefixSomeAttr(sceneId, MonsterId, 0.4)
		--21环~30环，三项值*1.2
		elseif currRound >= 21 and currRound <= 30 then
			x229023_RefixSomeAttr(sceneId, MonsterId, 0.6)
		--31环~40环，三项值*1.3
		elseif currRound >= 31 and currRound <= 40 then
			x229023_RefixSomeAttr(sceneId, MonsterId, 0.8)
		--41环~50环，三项值*1.4
		elseif currRound >= 41 and currRound <= 50 then
			x229023_RefixSomeAttr(sceneId, MonsterId, 1)
		--51环~60环，三项值*1.5
		elseif currRound >= 51 and currRound <= 60 then
			x229023_RefixSomeAttr(sceneId, MonsterId, 1.2)
		--61环~70环，三项值*1.6
		elseif currRound >= 61 and currRound <= 70 then
			x229023_RefixSomeAttr(sceneId, MonsterId, 1.4)
		--71环~80环，三项值*1.7
		elseif currRound >= 71 and currRound <= 80 then
