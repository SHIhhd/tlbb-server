...
x210241_g_MPInfo		=
{
	{ nam="少林派", des="#{event_dali_mp_sl}", key=1020, x=156, z=132, npc="慧易"			},
	{ nam="明教",   des="#{event_dali_mp_mj}", key=1021, x=163, z=143, npc="石宝"			},
	{ nam="丐帮",   des="#{event_dali_mp_gb}", key=1022, x=156, z=136, npc="简宁"			},
	{ nam="武当派", des="#{event_dali_mp_wd}", key=1023, x=163, z=136, npc="海风子"		},
	{ nam="峨嵋派", des="#{event_dali_mp_em}", key=1024, x=156, z=139, npc="路三娘"		},
	{ nam="星宿派", des="#{event_dali_mp_xx}", key=1025, x=163, z=136, npc="海风子"		},
	{ nam="天龙派", des="#{event_dali_mp_tl}", key=1026, x=163, z=132, npc="破贪"			},
	{ nam="天山派", des="#{event_dali_mp_ts}", key=1027, x=163, z=139, npc="程青霜"		},
	{ nam="逍遥派", des="#{event_dali_mp_xy}", key=1028, x=163, z=129, npc="澹台子羽"	},
}
