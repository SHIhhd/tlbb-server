...
function x809265_EquipFaileTimes( sceneId, selfId, nItemIndex1, nItemIndex2)
	...
	if sy_index ~= 30900007 and sy_index ~= 30900000 and sy_index ~= 31000102   then	--增加战备润物露
		BeginEvent(sceneId)
	...
	if sy_index == 30900007 or sy_index == 31000102  then
	...
	if ret == 0 then
		...
		LuaFnDelAvailableItem(sceneId,selfId,sy_index,1)
