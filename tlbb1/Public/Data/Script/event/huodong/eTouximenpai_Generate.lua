...
x808015_g_DLPosInfoList = {{
														...
														{
															sceneId=SCENE_MANTUOSHANZHUANG,
															sceneName="王夫人",
															G1posList = {
																						{x=136, z=137, r=3},
																						{x=125, z=128, r=3},
...
x808015_g_scenePosInfoList = {
	...
	{sceneId=SCENE_MANTUOSHANZHUANG, sceneLeader="王夫人", sceneName="曼陀山庄", minL=56, maxL=70,posList={
																						{x=115, z=169, r=8},{x=121, z=157, r=5},{x=99, z=178, r=5},{x=88, z=168, r=5},
																						{x=55, z=190, r=4},{x=52, z=179, r=5},{x=42, z=194, r=7},{x=36, z=206, r=6},
																						{x=52, z=180, r=5},{x=67, z=140, r=4},{x=70, z=129, r=5},{x=67, z=120, r=5},
																						{x=79, z=75, r=5},{x=71, z=51, r=8},{x=92, z=68, r=5},{x=91, z=25, r=5},
																						{x=96, z=25, r=5},{x=135, z=35, r=5},{x=166, z=40, r=8},{x=177, z=69, r=7},
																						{x=184, z=82, r=5},{x=190, z=79, r=5},{x=216, z=95, r=5},{x=178, z=118, r=8},
																						{x=185, z=130, r=5},{x=194, z=134, r=5},{x=217, z=158, r=5},{x=224, z=187, r=5},
																						{x=229, z=190, r=4},{x=152, z=125, r=4},
																					}
	},
}
