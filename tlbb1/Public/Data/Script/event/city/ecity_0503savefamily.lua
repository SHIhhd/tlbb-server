...
x600026_g_MenpaiInfo = {
	[0] = { Name = "少林",		NpcId = 1700008,	CopySceneName = "塔林",		Type = FUBEN_TALIN1,		    Map = "tongrenxiang_2.path",		Exit = "tongrenxiang_2_area.ini",	Monster = "tongrenxiang_2_monster_%d.ini", 	EntrancePos = { x = 28, z = 52 },	BackPos = { x = 38, z = 97 }, },
	[1] = { Name = "明教",		NpcId = 1700009,	CopySceneName = "光明洞",	Type = FUBEN_GUANGMINGDONG1,	Map = "guangmingdong_2.path",	Exit = "guangmingdong_2_area.ini",	Monster = "guangmingdong_2_monster_%d.ini", EntrancePos = { x = 19, z = 42 },	BackPos = { x = 98, z = 57 }, },
	[2] = { Name = "丐帮",		NpcId = 1700010,	CopySceneName = "酒窖",		Type = FUBEN_JIUJIAO1,			Map = "jiujiao_2.path",			Exit = "jiujiao_2_area.ini",		Monster = "jiujiao_2_monster_%d.ini", 		EntrancePos = { x = 45, z = 47 },	BackPos = { x = 91, z = 99 }, },
	[3] = { Name = "武当",		NpcId = 1700011,	CopySceneName = "灵性峰",	Type = FUBEN_LINGXINGFENG1,		Map = "lingxingfeng_2.path",		Exit = "lingxingfeng_2_area.ini",	Monster = "lingxingfeng_2_monster_%d.ini", 	EntrancePos = { x = 42, z = 46 },	BackPos = { x = 77, z = 86 }, },
	[4] = { Name = "峨嵋",		NpcId = 1700012,	CopySceneName = "桃花阵",	Type = FUBEN_TAOHUAZHEN1,		Map = "taohuazhen_2.path",		Exit = "taohuazhen_2_area.ini",		Monster = "taohuazhen_2_monster_%d.ini", 	EntrancePos = { x = 26, z = 46 },	BackPos = { x = 96, z = 73 }, },
	[5] = { Name = "天龙寺",	NpcId = 1700013,	CopySceneName = "塔底",		Type = FUBEN_TADI1,				Map = "tadi_2.path",				Exit = "tadi_2_area.ini",			Monster = "tadi_2_monster_%d.ini", 			EntrancePos = { x = 45, z = 48 },	BackPos = { x = 96, z = 67 }, },
	[6] = { Name = "星宿",		NpcId = 1700014,	CopySceneName = "五神洞",	Type = FUBEN_WUSHENDONG1,		Map = "wushendong_2.path",		Exit = "wushendong_2_area.ini",		Monster = "wushendong_2_monster_%d.ini", 	EntrancePos = { x = 14, z = 40 },	BackPos = { x = 142, z = 56 }, },
	[7] = { Name = "天山",		NpcId = 1700015,	CopySceneName = "折梅峰",	Type = FUBEN_ZHEMEIFENG1,		Map = "zhemeifeng_2.path",		Exit = "zhemeifeng_2_area.ini",		Monster = "zhemeifeng_2_monster_%d.ini", 	EntrancePos = { x = 29, z = 49 },	BackPos = { x = 90, z = 45 }, },
	[8] = { Name = "逍遥",		NpcId = 1700016,	CopySceneName = "谷底",		Type = FUBEN_GUDI1,				Map = "gudi_2.path",				Exit = "gudi_2_area.ini",			Monster = "gudi_2_monster_%d.ini", 			EntrancePos = { x = 42, z = 47 },	BackPos = { x = 124, z = 145 }, },
}
