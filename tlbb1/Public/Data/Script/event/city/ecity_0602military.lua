...
-- 这里的Nav文件和场景名字需要手动对应
x600032_g_CopySceneMap = {"tongrenxiang_1.path","guangmingdong_1.path","jiujiao_1.path",
											 "lingxingfeng_1.path","taohuazhen_1.path","wushendong_1.path",
											 "tadi_1.path","zhemeifeng_1.path","gudi_1.path"}
...
--x600032_g_CopySceneMap = "tadi_1.path"
