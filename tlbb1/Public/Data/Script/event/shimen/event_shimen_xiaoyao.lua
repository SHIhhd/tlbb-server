...
x229005_g_DingDianYinDaoList = {
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="时光机", scene=14, AreaName="思恩", subAreaName="凤凰琴", posx1=39, posz1=140, posx2=60, posz2=160},
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="时光机", scene=14, AreaName="珍珑", subAreaName="烂柯棋", posx1=135, posz1=142, posx2=162, posz2=157},
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="时光机", scene=14, AreaName="大观", subAreaName="圣贤书", posx1=37, posz1=46, posx2=59, posz2=66},
											 {menpai=MP_XIAOYAO  , itemId=40003026, itemName="时光机", scene=14, AreaName="点军", subAreaName="丹青画", posx1=135, posz1=52, posx2=150, posz2=64},
											}


--副本列表
x229005_g_FuBen_List = {
								{menpai=MP_XIAOYAO  , NpcName="冯阿三", scene=14, posx=62, posz=68, FubenName="谷底副本"},
								}       


--收集
x229005_g_ShouJiList = {
								{menpai=MP_XIAOYAO  , scene=14, itemId=40003027, itemName="逍遥木制零件"},-- count=5},
								{menpai=MP_XIAOYAO  , scene=14, itemId=40003028, itemName="逍遥石制零件"},-- count=5},
								{menpai=MP_XIAOYAO  , scene=14, itemId=40003029, itemName="逍遥铜制零件"},-- count=5},
							}	
...
x229005_g_AbilityNpcList = {
                    {menpai=MP_XIAOYAO  ,npcList={{name="木人傀儡", scene=14, x=47, z=72},
...
function x229005_KillMonster_Accept(sceneId, selfId)--杀怪
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 8)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_XunWu_Accept(sceneId, selfId)--寻物
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 1)--formet字符串索引
...
function x229005_SongXin_Accept(sceneId, selfId)--送信
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 0)--formet字符串索引
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart+3, x229005_g_Xin_ItemId )
	...
	local strMissionTarget = format("好久没有见%s%s了，请你帮我把这个%s交给他。", strNpcScene, strNpcName, x229005_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_DingDianYinDao_Accept(sceneId, selfId)--定点引导
	--获得玩家的门派
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--用一个临时表来存储对应门派在x229005_g_DingDianYinDaoList中的全部索引
	...
	AddItemListToHuman(sceneId, selfId)	
	Msg2Player(  sceneId, selfId,"#Y你得到了一个" .. x229005_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 3)--formet字符串索引
	...
	local strMissionTarget = format("请你在逍遥派%s找到%s，在它附近使用%s来读取它的记忆。", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_FuBenZhanDou_Accept(sceneId, selfId)--战斗副本
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_BuZhuo_Accept(sceneId, selfId)--捕捉
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 5)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_ShouJi_Accept(sceneId, selfId)--收集
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 6)--formet字符串索引
	...
	local strMissionTarget = format("请你帮我弄5个%s来。", x229005_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229005_Ability_Accept(sceneId, selfId)--开光
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229005_g_StrForePart, 7)--formet字符串索引
...
--任务入口函数
--**********************************
function x229005_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x229005_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229005_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229005_g_MissionId)		--得到任务在20个任务中的序列号
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--杀死怪物或玩家
--**********************************
function x229005_OnKillObject( sceneId, selfId, objdataId ,objId)--参数意思：场景号、玩家objId、怪物表位置号、怪物
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229005_g_MissionId)
...
--同门相助、投机取巧....直接完成当前环....
--**********************************
function x229005_HelpFinishOneHuan( sceneId, selfId, targetId, finishType )
