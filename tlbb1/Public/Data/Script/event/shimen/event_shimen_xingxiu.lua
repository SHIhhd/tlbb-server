...
x229007_g_DingDianYinDaoList = {
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="五毒虫", scene=16, AreaName="日月宫", subAreaName="毒蟾蜍箱", posx1=88, posz1=50, posx2=103, posz2=60},
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="五毒虫", scene=16, AreaName="方丈殿", subAreaName="毒蜈蚣箱", posx1=82, posz1=94, posx2=94, posz2=102},
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="五毒虫", scene=16, AreaName="瀛洲殿", subAreaName="毒蜘蛛箱", posx1=98, posz1=94, posx2=110, posz2=102},
											 {menpai=MP_XINGSU   , itemId=40003034, itemName="五毒虫", scene=16, AreaName="蓬莱殿", subAreaName="毒蠍子箱", posx1=119, posz1=69, posx2=132, posz2=79},
											}


--副本列表
x229007_g_FuBen_List = {
								{menpai=MP_XINGSU   , NpcName="红玉", scene=16, posx=128, posz=78, FubenName="五神洞副本"},
								}       

--收集
x229007_g_ShouJiList = {
								{menpai=MP_XINGSU   , scene=16, itemId=40003035, itemName="毒蜈蚣"},-- count=5},
								{menpai=MP_XINGSU   , scene=16, itemId=40003036, itemName="毒蟾蜍"},-- count=5},								
								{menpai=MP_XINGSU   , scene=16, itemId=40003037, itemName="毒蜘蛛"},-- count=5},								
							}	
...
x229007_g_AbilityNpcList = {
                    {menpai=MP_XINGSU   ,npcList={{name="西域药篓子", scene=16, x=131, z=48},
                                                  {name="契丹药篓子", scene=16, x=136, z=48},
                                                  {name="大理药篓子", scene=16, x=142, z=48}}
										},
									}
...
function x229007_KillMonster_Accept(sceneId, selfId)--杀怪
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 8)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_XunWu_Accept(sceneId, selfId)--寻物
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 1)--formet字符串索引
...
function x229007_SongXin_Accept(sceneId, selfId)--送信
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 0)--formet字符串索引
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart+3, x229007_g_Xin_ItemId )
	...
	local strMissionTarget = format("好久没有见%s%s了，请你帮我把这个%s交给他。", strNpcScene, strNpcName, x229007_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_DingDianYinDao_Accept(sceneId, selfId)--定点引导
	--获得玩家的门派
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--用一个临时表来存储对应门派在x229007_g_DingDianYinDaoList中的全部索引
	...
	AddItemListToHuman(sceneId, selfId)	
	Msg2Player(  sceneId, selfId,"#Y你得到了一个" .. x229007_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 3)--formet字符串索引
	...
	local strMissionTarget = format("请你在星宿海%s找到%s，使用%s来喂养它。", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_FuBenZhanDou_Accept(sceneId, selfId)--战斗副本
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_BuZhuo_Accept(sceneId, selfId)--捕捉
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 5)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_ShouJi_Accept(sceneId, selfId)--收集
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 6)--formet字符串索引
	...
	local strMissionTarget = format("请你帮我弄5个%s来。", x229007_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229007_Ability_Accept(sceneId, selfId)--开光
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229007_g_StrForePart, 7)--formet字符串索引
...
--任务入口函数
--**********************************
function x229007_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x229007_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229007_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229007_g_MissionId)		--得到任务在20个任务中的序列号
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--杀死怪物或玩家
--**********************************
function x229007_OnKillObject( sceneId, selfId, objdataId ,objId)--参数意思：场景号、玩家objId、怪物表位置号、怪物
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229007_g_MissionId)
...
--同门相助、投机取巧....直接完成当前环....
--**********************************
function x229007_HelpFinishOneHuan( sceneId, selfId, targetId, finishType )
