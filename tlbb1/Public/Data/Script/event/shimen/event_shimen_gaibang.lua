...
x229008_g_FormatList = {
								"好久没有见到%n了，很是想念啊。这个%s是我的一点心意，请你把它送过去吧。#r  #e00f000小提示：#e000000#r  你可以在丐帮总舵找到#R张全祥#W#{_INFOAIM93,118,10,张全祥}，请他把你送往各大城市。#B#r  东西送到后，请到师门任务发布人#W洪通#{_INFOAIM92,77,10,洪通}处交还任务。#r#{SMRW_090206_01}",
								"我的%i怎么不见了？如果你能帮我找回来，我是不会亏待你的。#r  #e00f000小提示：#e000000#r  你可以在丐帮总舵找到#R张全祥#W#{_INFOAIM93,118,10,张全祥}，请他把你送往各大城市。#r#{SMRW_090206_01}",
								"%n为非作歹，我有心去教训一下，可惜没有时间，你能代劳吗？#r  #e00f000小提示：#e000000#r  你可以在丐帮总舵找到#R张全祥#W#{_INFOAIM93,118,10,张全祥}，请他把你送往各大城市。#r#{SMRW_090206_01}",
								"请你使用%s，在丐帮%s的%s中打酒。#r  #e00f000小提示：#e000000#r  当你来到需要打酒的酒缸附近时，你可以按#gfff0f0Alt+A#g000000可以打开物品栏，点击#gfff0f0“任务”#g000000页面就可以打开任务物品栏，右键点击#gfff0f0酒坛#g000000，就可以打到酒了。#r#{SMRW_090206_01}",
								"请你去找到%s， 他会带你去挑战%s的。#r  #e00f000小提示：#e000000#r  佛印兄弟就在丐帮总舵#{_INFOAIM41,144,10,佛印}。#r#{SMRW_090206_01}",
								...
								"请你在丐帮大院四处看看，帮我找来5个%s。#r  #e00f000小提示：#e000000#r  你可以在屏幕右上角的小地图上找到黄色的指示点。#r#{SMRW_090206_01}",
								"请给%s送去一个%i吧，事成之后，我会给你报酬的！#r  #e00f000小提示：#e000000#r  全冠清舵主就在丐帮总舵#{_INFOAIM120,63,10,全冠清}。#r  陈孤雁长老就在丐帮总舵#{_INFOAIM91,98,10,陈孤雁}。#r  吴长风长老就在丐帮总舵#{_INFOAIM114,91,10,吴长风}。#B#r  东西送到后，请到师门任务发布人#W洪通#{_INFOAIM92,77,10,洪通}处交还任务。#r#{SMRW_090206_01}",
...
x229008_g_DingDianYinDaoList = {
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="酒坛", scene=10, AreaName="小桃园", subAreaName="酒缸", posx1=33, posz1=141, posx2=48, posz2=156},
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="酒坛", scene=10, AreaName="杜康祠", subAreaName="酒缸", posx1=124, posz1=106, posx2=137, posz2=115},
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="酒坛", scene=10, AreaName="演兵坛", subAreaName="酒缸", posx1=41, posz1=32, posx2=53, posz2=42},
											 {menpai=MP_GAIBANG  , itemId=40003003, itemName="酒坛", scene=10, AreaName="西厢房", subAreaName="酒缸", posx1=48, posz1=83, posx2=62, posz2=93},
											}


--副本列表
x229008_g_FuBen_List = {
								{menpai=MP_GAIBANG  , NpcName="佛印", scene=10, posx=41, posz=144, FubenName="酒窖副本"},
								}       

--收集
x229008_g_ShouJiList = {
								{menpai=MP_GAIBANG  , scene=10, itemId=40003008, itemName="小青蛇"},-- count=5},
								{menpai=MP_GAIBANG  , scene=10, itemId=40003009, itemName="小白蛇"},-- count=5},
								{menpai=MP_GAIBANG  , scene=10, itemId=40003010, itemName="小红蛇"},-- count=5},
							}	
...
x229008_g_AbilityNpcList = {
                    {menpai=MP_GAIBANG  ,npcList={{name="全冠清", scene=10, x=120, z=63},
                                                  {name="陈孤雁", scene=10, x=91, z=99},
                                                  {name="吴长风", scene=10, x=114, z=81}}
										},
									}
...
function x229008_KillMonster_Accept(sceneId, selfId)--杀怪
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 8)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_XunWu_Accept(sceneId, selfId)--寻物
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 1)--formet字符串索引
...
function x229008_SongXin_Accept(sceneId, selfId)--送信
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 0)--formet字符串索引
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart+3, x229008_g_Xin_ItemId )
	...
	local strMissionTarget = format("好久没有见%s%s了，请你帮我把这个%s交给他。", strNpcScene, strNpcName, x229008_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_DingDianYinDao_Accept(sceneId, selfId)--定点引导
	--获得玩家的门派
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--用一个临时表来存储对应门派在x229008_g_DingDianYinDaoList中的全部索引
	...
	AddItemListToHuman(sceneId, selfId)
	Msg2Player(  sceneId, selfId,"#Y你得到了一个" .. x229008_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 3)--formet字符串索引
	...
	local strMissionTarget = format("请你使用%s，在丐帮%s的%s中打酒。", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_FuBenZhanDou_Accept(sceneId, selfId)--战斗副本
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_BuZhuo_Accept(sceneId, selfId)--捕捉
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 5)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_ShouJi_Accept(sceneId, selfId)--收集
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 6)--formet字符串索引
	...
	local strMissionTarget = format("请你帮我弄5个%s来。", x229008_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229008_Ability_Accept(sceneId, selfId)--开光
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229008_g_StrForePart, 7)--formet字符串索引
...
--任务入口函数
--**********************************
function x229008_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x229008_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229008_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229008_g_MissionId)		--得到任务在20个任务中的序列号
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--杀死怪物或玩家
--**********************************
function x229008_OnKillObject( sceneId, selfId, objdataId ,objId)--参数意思：场景号、玩家objId、怪物表位置号、怪物
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229008_g_MissionId)
...
--同门相助、投机取巧....直接完成当前环....
--**********************************
function x229008_HelpFinishOneHuan( sceneId, selfId, targetId, finishType )
