...
x229009_g_menpainpc_table =  {
	...
	{menpaiid=MP_MANTUO,  menpainame="曼陀山庄", name="王夫人", title="曼陀山庄庄主",	x=140, z=75},
}           

--男
x229009_g_MaleTitleInfo = {
	{tlvl=1, mpp=0,    slt="少林侠士", mjt="明教侠士", gbt="丐帮侠士", wdt="武当侠士", emt="峨嵋侠士", xxt="星宿侠士", tlt="天龙侠士", tst="天山侠士", xyt="逍遥侠士", mtt="曼陀侠士"},
	{tlvl=2, mpp=1000, slt="灰衣护法", mjt="侍火侠士", gbt="青莲弟子", wdt="青冥居士", emt="清风居士", xxt="行瘟郎君", tlt="藏经侠士", tst="阳天部众", xyt="抚琴居士", mtt="凝徽琴师"},
	{tlvl=3, mpp=2500, slt="金身罗汉", mjt="护教法王", gbt="玄武长老", wdt="无为真人", emt="玉龙侠士", xxt="催命判官", tlt="崇圣天师", tst="天山苍鹰", xyt="洛神侠士", mtt="拂晓琴宗"},
	{tlvl=4, mpp=5000, slt="地藏菩萨", mjt="光明神使", gbt="掌棒龙头", wdt="武当天尊", emt="峨嵋仙人", xxt="毒手医仙", tlt="天南龙王", tst="混元山神", xyt="逍遥神龙", mtt="渡情琴仙"},
}
--女	
x229009_g_femaleTitleInfo = {	
	{tlvl=1, mpp=0,	   slt="少林侠女", mjt="明教侠女", gbt="丐帮侠女", wdt="武当侠女", emt="峨嵋侠女", xxt="星宿侠女", tlt="天龙侠女", tst="天山侠女", xyt="逍遥侠女", mtt="曼陀侠女"},
	{tlvl=2, mpp=1000, slt="白衣侍者", mjt="侍火侠女", gbt="白莲弟子", wdt="白云居士", emt="明月居士", xxt="行瘟娘子", tlt="藏经侠女", tst="昊天部众", xyt="莳花居士", mtt="聆韵琴师"},
	{tlvl=3, mpp=2500, slt="渡世观音", mjt="护教散人", gbt="朱雀长老", wdt="清静散人", emt="金凤侠女", xxt="夺命夜叉", tlt="崇圣天女", tst="天山雪雕", xyt="淩波侠女", mtt="清照琴宗"},
	{tlvl=4, mpp=5000, slt="迦蓝菩萨", mjt="光明圣女", gbt="掌钵龙女", wdt="武当仙子", emt="峨嵋仙子", xxt="毒手药王", tlt="天南龙女", tst="混元花神", xyt="逍遥圣女", mtt="观情琴仙"},
}
...
x229009_g_shimentitle_bonusitem = {
	...
	{menpaiid=MP_MANTUO,	bonusItem=10113004},
}
...
function x229009_GetCurShimenTitleLevel(menpai, title )  --, titleinfo)
	...
	elseif menpai == MP_MANTUO then
		for i=1, 4 do
			if title == x229009_g_MaleTitleInfo[i].mtt then
				titlelevel = x229009_g_MaleTitleInfo[i].tlvl
				return titlelevel
			end
			if title == x229009_g_femaleTitleInfo[i].mtt then
				titlelevel = x229009_g_femaleTitleInfo[i].tlvl
				return titlelevel
			end
		end	
