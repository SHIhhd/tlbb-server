...
x229006_g_DingDianYinDaoList = {
											 {menpai=MP_TIANSHAN , itemId=40003038, itemName="天池水", scene=17, AreaName="玄冰戽", subAreaName="玄冰戽", posx1=54, posz1=31, posx2=67, posz2=45},
											 {menpai=MP_TIANSHAN , itemId=40003039, itemName="石露水", scene=17, AreaName="寒冰戽", subAreaName="寒冰戽", posx1=70, posz1=57, posx2=77, posz2=69},
											 {menpai=MP_TIANSHAN , itemId=40003040, itemName="冷泉水", scene=17, AreaName="碎冰戽", subAreaName="碎冰戽", posx1=117, posz1=85, posx2=130, posz2=96},
											 {menpai=MP_TIANSHAN , itemId=40003041, itemName="融冰水", scene=17, AreaName="岩冰戽", subAreaName="岩冰戽", posx1=123, posz1=46, posx2=135, posz2=57},
											}


--副本列表
x229006_g_FuBen_List = {
								{menpai=MP_TIANSHAN , NpcName="菊剑", scene=17, posx=99, posz=45, FubenName="折梅峰副本"},
								}       
...
x229006_g_ShouJiList = {
								{menpai=MP_TIANSHAN , scene=17, itemId=40003042, itemName="葡萄乾"},-- count=5},
								{menpai=MP_TIANSHAN , scene=17, itemId=40003043, itemName="雪莲花"},-- count=5},
								{menpai=MP_TIANSHAN , scene=17, itemId=40003044, itemName="哈密瓜"},-- count=5},
							}	


--送生活技能npc列表
x229006_g_AbilityNpcList = {
                    {menpai=MP_TIANSHAN ,npcList={{name="石嫂", scene=17, x=123, z=67},
...
function x229006_KillMonster_Accept(sceneId, selfId)--杀怪
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 8)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_XunWu_Accept(sceneId, selfId)--寻物
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 1)--formet字符串索引
...
function x229006_SongXin_Accept(sceneId, selfId)--送信
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 0)--formet字符串索引
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart+3, x229006_g_Xin_ItemId )
	...
	local strMissionTarget = format("好久没有见%s%s了，请你帮我把这个%s交给他。", strNpcScene, strNpcName, x229006_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_DingDianYinDao_Accept(sceneId, selfId)--定点引导
	--获得玩家的门派
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--用一个临时表来存储对应门派在x229006_g_DingDianYinDaoList中的全部索引
	...
	AddItemListToHuman(sceneId, selfId)
	Msg2Player(  sceneId, selfId,"#Y你得到了一个" .. x229006_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 3)--formet字符串索引
	...
	local strMissionTarget = format("请你在天山找到%s，把%s注入其中。", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_FuBenZhanDou_Accept(sceneId, selfId)--战斗副本
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_BuZhuo_Accept(sceneId, selfId)--捕捉
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 5)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_ShouJi_Accept(sceneId, selfId)--收集
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 6)--formet字符串索引
	...
	local strMissionTarget = format("请你帮我弄5个%s来。", x229006_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229006_Ability_Accept(sceneId, selfId)--开光
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229006_g_StrForePart, 7)--formet字符串索引
...
--任务入口函数
--**********************************
function x229006_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x229006_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229006_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229006_g_MissionId)		--得到任务在20个任务中的序列号
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--杀死怪物或玩家
--**********************************
function x229006_OnKillObject( sceneId, selfId, objdataId ,objId)--参数意思：场景号、玩家objId、怪物表位置号、怪物
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229006_g_MissionId)
...
--同门相助、投机取巧....直接完成当前环....
--**********************************
function x229006_HelpFinishOneHuan( sceneId, selfId, targetId, finishType )
