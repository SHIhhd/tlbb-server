...
x229003_g_DingDianYinDaoList = {
											 {menpai=MP_EMEI     , itemId=40003030, itemName="峨嵋仙露", scene=15, AreaName="珙椿晓雨", subAreaName="金顶凤凰", posx1=39, posz1=32, posx2=57, posz2=46},
											 {menpai=MP_EMEI     , itemId=40003030, itemName="峨嵋仙露", scene=15, AreaName="白水秋风", subAreaName="灵泉凤凰", posx1=134, posz1=33, posx2=157, posz2=54},
											 {menpai=MP_EMEI     , itemId=40003030, itemName="峨嵋仙露", scene=15, AreaName="私语台", subAreaName="佛光凤凰", posx1=32, posz1=139, posx2=46, posz2=160},
											 {menpai=MP_EMEI     , itemId=40003030, itemName="峨嵋仙露", scene=15, AreaName="长生殿", subAreaName="万年凤凰", posx1=132, posz1=148, posx2=160, posz2=160},
											}


--副本列表
x229003_g_FuBen_List = {
								{menpai=MP_EMEI     , NpcName="孟青青", scene=15, posx=96, posz=73, FubenName="桃花阵副本"},
								}       

--收集
x229003_g_ShouJiList = {
								{menpai=MP_EMEI     , scene=15, itemId=40003031, itemName="遗失的首饰"},-- count=5},
								{menpai=MP_EMEI     , scene=15, itemId=40003032, itemName="遗失的祭品"},-- count=5},								
								{menpai=MP_EMEI     , scene=15, itemId=40003033, itemName="遗失的珠宝"},-- count=5},								
							}	
...
x229003_g_AbilityNpcList = {
                    {menpai=MP_EMEI     ,npcList={{name="桃花仙", scene=15, x=156, z=99},
...
function x229003_KillMonster_Accept(sceneId, selfId)--杀怪
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 8)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_XunWu_Accept(sceneId, selfId)--寻物
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 1)--formet字符串索引
...
function x229003_SongXin_Accept(sceneId, selfId)--送信
  ...
  local roll = random(3)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 0)--formet字符串索引
  ...
  SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart+3, shoujiItemId )
	...
	local strMissionTarget = format("好久没有见%s%s了，请你帮我把这个%s交给他。", strNpcScene, strNpcName, x229003_g_ShouJiList[ roll ].itemName )
	AddText(sceneId, strMissionTarget)
	
end

--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_DingDianYinDao_Accept(sceneId, selfId)--定点引导
	--获得玩家的门派
	local playerMenpai = GetMenPai(sceneId, selfId)
	local a = {}
	local index = 1
	--用一个临时表来存储对应门派在x229003_g_DingDianYinDaoList中的全部索引
	...
	AddItemListToHuman(sceneId, selfId)	
	Msg2Player(  sceneId, selfId,"#Y你得到了一个" .. x229003_g_DingDianYinDaoList[a[ret]].itemName, MSG2PLAYER_PARA )
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 3)--formet字符串索引
	...
	local strMissionTarget = format("请你在峨嵋山%s找到%s，使用%s来喂养它。", 
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_FuBenZhanDou_Accept(sceneId, selfId)--战斗副本
	local playerMenpai = GetMenPai(sceneId, selfId)
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_BuZhuo_Accept(sceneId, selfId)--捕捉
	local playerLevel = GetLevel(sceneId, selfId)
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 5)--formet字符串索引
...
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_ShouJi_Accept(sceneId, selfId)--收集
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 6)--formet字符串索引
	...
	local strMissionTarget = format("请你帮我弄5个%s来。", x229003_g_ShouJiList[a[ret]].itemName)
	AddText(sceneId, strMissionTarget)
end
--/////////////////////////////////////////////////////////////////////////////////////////////////////
function x229003_Ability_Accept(sceneId, selfId)--开光
	...
	SetMissionByIndex(sceneId, selfId, misIndex, x229003_g_StrForePart, 7)--formet字符串索引
...
--任务入口函数
--**********************************
function x229003_OnDefaultEvent( sceneId, selfId, targetId )	--点击该任务后执行此脚本
...
function x229003_OnAbandon( sceneId, selfId )
	----PrintStr("OnAbandon...")
	if IsHaveMission(sceneId, selfId, x229003_g_MissionId) > 0 then	
		local misIndex = GetMissionIndexByID(sceneId,selfId,x229003_g_MissionId)		--得到任务在20个任务中的序列号
		local missionType = GetMissionParam(sceneId, selfId, misIndex, 1)
...
--杀死怪物或玩家
--**********************************
function x229003_OnKillObject( sceneId, selfId, objdataId ,objId)--参数意思：场景号、玩家objId、怪物表位置号、怪物
	local misIndex = GetMissionIndexByID(sceneId,selfId,x229003_g_MissionId)
...
--同门相助、投机取巧....直接完成当前环....
--**********************************
function x229003_HelpFinishOneHuan( sceneId, selfId, targetId, finishType )
