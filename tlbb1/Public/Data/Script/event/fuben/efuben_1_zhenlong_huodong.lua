...
x401001_g_startTickCount = 5;				--开始出怪的时间（单位：次）
...
function x401001_MakeCopyScene(sceneId, selfId, nearmembercount)
	...
	LuaFnSetSceneLoad_Map(sceneId, "zhenlong.path");										--地图是必须选取的，而且必须在Config/SceneInfo.ini里配置好
