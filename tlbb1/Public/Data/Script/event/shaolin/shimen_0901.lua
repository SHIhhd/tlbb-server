...
--任务文本描述
x220901_g_MissionName="塔林"
x220901_g_MissionInfo="#{MPFB_081023_10}"  --任务描述
x220901_g_MissionTarget="#{MPFB_081023_11}"	--任务目标
...
x220901_g_CopySceneType=FUBEN_TALIN	--副本类型，定义在ScriptGlobal.lua里面
...
x220901_g_Fuben_X=28				--进入副本的位置X
x220901_g_Fuben_Z=52				--进入副本的位置Z
...
function x220901_MakeCopyScene( sceneId, selfId)
	...
	LuaFnSetSceneLoad_Map(sceneId, "tongrenxiang.path"); --地图是必须选取的，而且必须在Config/SceneInfo.ini里配置好
