...
--免疫Buff....
x402280_Buff_MianYi1	= 10472	--免疫一些负面效果....
x402280_Buff_MianYi2	= 10471	--免疫普通隐身....
...
x402280_SkillA_Damage =	--简单版缥缈峰使用伤害降低了的版本....
{
	[0] = 23815/4,
	[1] = 16570/4,
	[2] = 18820/4,
...
x402280_BrotherName = "不平道人"	--兄弟的名字....


--AI Index....
x402280_IDX_KuangBaoMode	= 1	--狂暴模式....0未狂暴 1需要进入狂暴 2已经进入狂暴
x402280_IDX_CurSkillIndex	= 2	--接下来该使用BC中的哪个技能....
x402280_IDX_CD_SkillA			= 3	--A技能的CD....
x402280_IDX_CD_SkillBC		= 4	--BC技能的CD....

x402280_IDX_CombatFlag 		= 1	--是否处于战斗状态的标志....
