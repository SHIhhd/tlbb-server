...
x015002_g_DeliveryScript = 006668
x015002_g_DeliveryList = {1010240}
--**********************************
--事件列表
--**********************************
function x015002_UpdateEventList( sceneId, selfId,targetId )
	...
	for i, Deliveryidx in x015002_g_DeliveryList do
		CallScriptFunction( x015002_g_DeliveryScript, "OnEnumerate",sceneId, selfId, targetId ,Deliveryidx)
	end
...
function x015002_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	--配表任务
	for i,Deliveryidx in x015002_g_DeliveryList do
		if eventId == x015002_g_DeliveryScript then
...
function x015002_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i,Deliveryidx in x015002_g_DeliveryList do
		if missionScriptId == x015002_g_DeliveryScript then
