...
x027004_g_KillMonsterScript = 006666
x027004_g_KillMonsterList = {1000170,1000171,1000172}
--**********************************
--事件列表
--**********************************
function x027004_UpdateEventList( sceneId, selfId,targetId )
	...
	for i,KillMonsteridx in x027004_g_KillMonsterList do
		CallScriptFunction( x027004_g_KillMonsterScript, "OnEnumerate",sceneId, selfId, targetId,KillMonsteridx)
	end
...
function x027004_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i,KillMonsteridx in x027004_g_KillMonsterList do
		if eventId == x027004_g_KillMonsterScript then
...
function x027004_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i,KillMonsteridx in x027004_g_KillMonsterList do
		if missionScriptId == x027004_g_KillMonsterScript then
