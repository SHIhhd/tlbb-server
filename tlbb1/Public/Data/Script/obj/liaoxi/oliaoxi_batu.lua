...
x021000_g_LootItemscript = 006667
x021000_g_LootItemList = {1030090,1030091}
--**********************************
--事件列表
--**********************************
function x021000_UpdateEventList( sceneId, selfId,targetId )
	...
	for i, LootItemidx in x021000_g_LootItemList do
		CallScriptFunction( x021000_g_LootItemscript, "OnEnumerate",sceneId, selfId, targetId ,LootItemidx)
	end
...
function x021000_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i, LootItemidx in x021000_g_LootItemList do
		if eventId == x021000_g_LootItemscript then
...
function x021000_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	...
	local ret = 0
	for i, LootItemidx in x021000_g_LootItemList do
		if missionScriptId == x021000_g_LootItemscript then
