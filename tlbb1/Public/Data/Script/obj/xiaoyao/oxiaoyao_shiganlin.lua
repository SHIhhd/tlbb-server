...
function x014012_OnDefaultEvent( sceneId, selfId,targetId )
	x014012_UpdateEventList( sceneId, selfId, targetId )
end
...
function x014012_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	for i, findId in x014012_g_eventList do
		if eventId == findId then
			CallScriptFunction( eventId, "OnDefaultEvent",sceneId, selfId, targetId, GetNumText(),x014012_g_ScriptId )
			return
		end
	end
end
