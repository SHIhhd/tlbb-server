...
--脚本号
x032002_g_scriptId = 032002

--所拥有的事件ID列表
x032002_g_eventList={}
x032002_g_DeliveryScript = 006668
x032002_g_DeliveryList = {1010130,1010132}
x032002_g_KillMonsterScript = 006666
x032002_g_KillMonsterList = {1000130,1000131,1000132}
--**********************************
--事件列表
--**********************************
function x032002_UpdateEventList( sceneId, selfId,targetId )
	...
	for i, Deliveryidx in x032002_g_DeliveryList do
		CallScriptFunction( x032002_g_DeliveryScript, "OnEnumerate",sceneId, selfId, targetId ,Deliveryidx)
	end
	for i,KillMonsteridx in x032002_g_KillMonsterList do
		CallScriptFunction( x032002_g_KillMonsterScript, "OnEnumerate",sceneId, selfId, targetId,KillMonsteridx)
	end
...
function x032002_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i,Deliveryidx in x032002_g_DeliveryList do
		if eventId == x032002_g_DeliveryScript then
			CallScriptFunction( eventId, "OnDefaultEvent",sceneId, selfId, targetId,Deliveryidx)
		end
	end
	for i,KillMonsteridx in x032002_g_KillMonsterList do
		if eventId == x032002_g_KillMonsterScript then
...
function x032002_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i, Deliveryidx in x032002_g_DeliveryList do
		if missionScriptId == x032002_g_DeliveryScript then
	...
	for i,KillMonsteridx in x032002_g_KillMonsterList do
		if missionScriptId == x032002_g_KillMonsterScript then
