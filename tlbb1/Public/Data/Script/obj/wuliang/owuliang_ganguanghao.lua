...
x006005_g_LootItemscript = 006667
x006005_g_LootItemList = {1030001}
--**********************************
--事件列表
--**********************************
function x006005_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"  我瞧那葛师妹对我也是暗中有意，嘿嘿，不如……")
	for i, LootItemidx in x006005_g_LootItemList do
		CallScriptFunction( x006005_g_LootItemscript, "OnEnumerate",sceneId, selfId, targetId ,LootItemidx)
	end
...
function x006005_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i, LootItemidx in x006005_g_LootItemList do
		if eventId == x006005_g_LootItemscript then
...
function x006005_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	...
	local ret = 0
	for i, LootItemidx in x006005_g_LootItemList do
		if missionScriptId == x006005_g_LootItemscript then
