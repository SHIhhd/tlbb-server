...
--	end
	--【25Q2神工值改造】
	local ibPowerCost = CallScriptFunction( ABILITYLOGIC_ID, "CalcIBPowerCostCaiJi", sceneId, selfId, GPInfo.abilityId, GPInfo.needLevel )
...
--	CallScriptFunction( ABILITYLOGIC_ID, "EnergyCostCaiJi", sceneId, selfId, GPInfo.abilityId, GPInfo.needLevel )
	--【25Q2神工值改造】
	CallScriptFunction( ABILITYLOGIC_ID, "IBPowerCostCaiJi", sceneId, selfId, GPInfo.abilityId, GPInfo.needLevel )
	return OR_OK
end
