...
x026003_g_KillMonsterScript = 006666
x026003_g_KillMonsterList = {1000070}
--**********************************
--事件列表
--**********************************
function x026003_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId, "  为什么……为什么……#r  我的阿毛啊……#r  娘对不起你啊……#r  阿毛……#r  呜呜呜呜呜……")	
	for i,KillMonsteridx in x026003_g_KillMonsterList do
		CallScriptFunction( x026003_g_KillMonsterScript, "OnEnumerate",sceneId, selfId, targetId,KillMonsteridx)
	end
...
function x026003_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i,KillMonsteridx in x026003_g_KillMonsterList do
		if eventId == x026003_g_KillMonsterScript then
...
function x026003_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i,KillMonsteridx in x026003_g_KillMonsterList do
		if missionScriptId == x026003_g_KillMonsterScript then
