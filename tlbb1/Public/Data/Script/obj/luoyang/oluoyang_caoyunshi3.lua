...
x311008_g_DeliveryScript = 006668
x311008_g_DeliveryList = {1018722}
--龟兔赛跑任务号
...
function x311008_OnDefaultEvent( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		if x311008_OnIsFillPlayCard(sceneId, selfId, targetId) == 1 then
			...
			AddNumText( sceneId, x311008_g_scriptId, "了解漕运", 11, 1 )
			AddNumText( sceneId, x311008_g_scriptId, "开始漕运", 7, 2 )
			for i,Deliveryidx in x311008_g_DeliveryList do
				CallScriptFunction( x311008_g_DeliveryScript, "OnEnumerate",sceneId, selfId, targetId ,Deliveryidx)
			end
...
function x311008_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	--配表任务
	for i,Deliveryidx in x311008_g_DeliveryList do
		if eventId == x311008_g_DeliveryScript then
...
function x311008_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	...
	local ret = 0
	for i,Deliveryidx in x311008_g_DeliveryList do
		if missionScriptId == x311008_g_DeliveryScript then
