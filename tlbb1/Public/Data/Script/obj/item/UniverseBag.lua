...
x300083_GiftList[2]={{item=30008061,num=1},{item=10124153,num=1}}
x300083_GiftList[3]={{item=30008062,num=1},{item=30607002,num=1}}
x300083_GiftList[4]={{item=30008063,num=1},{item=30008027,num=1},{item=20309018,num=8}}
x300083_GiftList[5]={{item=30008064,num=1},{item=20309018,num=16},{item=30008027,num=1},{item=10141872,num=1}}
x300083_GiftList[6]={{item=30008065,num=1},{item=30008027,num=2}}
x300083_GiftList[7]={{item=30008027,num=1}}

--这里的是要程序进行绑定的物品,必须一个一个地给,所以物品数量都是1,有多个的就写多个ID了。
x300083_BindGiftList = {}
x300083_BindGiftList[1]={30008066}
