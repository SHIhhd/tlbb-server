...
----------------------------------------------------------------------------------------
-- 神器配方表 幽篁漱玉琴图样
x335134_g_CompoundInfo[1123]	= {
	abilityId = ABILITY_ZHUZAO,
	recipeLevel = 1,
	matTbl = 
	{
		{ matList = x335134_g_Stuff[1], count = 1, Product = 10306000, },
		{ matList = x335134_g_Stuff[2], count = 1, Product = 10306001, },
		{ matList = x335134_g_Stuff[3], count = 1, Product = 10306002, },
		{ matList = x335134_g_Stuff[4], count = 1, Product = 10306003, },
		{ matList = x335134_g_Stuff[5], count = 1, Product = 10306004, },
		{ matList = x335134_g_Stuff[6], count = 1, Product = 10306005, },
	},
}
-- 神器配方表 大楚秋声图样
x335134_g_CompoundInfo[1124]	= {
	abilityId = ABILITY_ZHUZAO,
	recipeLevel = 1,
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10306103, },
	},
}
-- 神器配方表 大楚秋声图样
x335134_g_CompoundInfo[1125]	= {
	abilityId = ABILITY_ZHUZAO,
	recipeLevel = 1,
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10306101, },
	},
}
-- 神器配方表 大楚秋声图样
x335134_g_CompoundInfo[1126]	= {
	abilityId = ABILITY_ZHUZAO,
	recipeLevel = 1,
	matTbl = 
	{
		{ matList = x335134_g_Stuff[7], count = 1, Product = 10306102, },
	},
}
