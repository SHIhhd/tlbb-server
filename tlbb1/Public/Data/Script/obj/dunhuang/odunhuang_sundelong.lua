...
x008014_g_DeliveryScript = 006668
x008014_g_DeliveryList = {1010239}
x008014_g_KillMonsterScript = 006666
x008014_g_KillMonsterList = {1000223}
--**********************************
--事件列表
--**********************************
function x008014_UpdateEventList( sceneId, selfId,targetId )
	...
	--配表任务
	for i,Deliveryidx in x008014_g_DeliveryList do
		CallScriptFunction( x008014_g_DeliveryScript, "OnEnumerate",sceneId, selfId, targetId ,Deliveryidx)
	end
	for i,KillMonsteridx in x008014_g_KillMonsterList do
		CallScriptFunction( x008014_g_KillMonsterScript, "OnEnumerate",sceneId, selfId, targetId,KillMonsteridx)
	end
...
function x008014_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i,Deliveryidx in x008014_g_DeliveryList do
		if eventId == x008014_g_DeliveryScript then
			CallScriptFunction( eventId, "OnDefaultEvent",sceneId, selfId, targetId,Deliveryidx)
		end
	end
	for i,KillMonsteridx in x008014_g_KillMonsterList do
		if eventId == x008014_g_KillMonsterScript then
...
function x008014_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i, Deliveryidx in x008014_g_DeliveryList do
		if missionScriptId == x008014_g_DeliveryScript then
	...
	for i,KillMonsteridx in x008014_g_KillMonsterList do
		if missionScriptId == x008014_g_KillMonsterScript then
