...
x008013_g_DeliveryScript = 006668
x008013_g_DeliveryList = {1010238}
--**********************************
--事件列表
--**********************************
function x008013_UpdateEventList( sceneId, selfId,targetId )
	...
	--配表任务
	for i,Deliveryidx in x008013_g_DeliveryList do
		CallScriptFunction( x008013_g_DeliveryScript, "OnEnumerate",sceneId, selfId, targetId ,Deliveryidx)
	end
...
function x008013_OnEventRequest( sceneId, selfId, targetId, eventId )
	--配表任务
	for i,Deliveryidx in x008013_g_DeliveryList do
		if eventId == x008013_g_DeliveryScript then
...
function x008013_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	...
	local ret = 0
	for i,Deliveryidx in x008013_g_DeliveryList do
		if missionScriptId == x008013_g_DeliveryScript then
