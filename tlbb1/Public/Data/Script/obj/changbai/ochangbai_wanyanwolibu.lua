...
x022005_g_LootItemScript = 006667
x022005_g_LootItemList = {1030101}
--**********************************
--事件列表
--**********************************
function x022005_UpdateEventList( sceneId, selfId,targetId )
	...
	AddText(sceneId,"  叔叔的病都是纥石烈人害的，我一定要消灭纥石烈人，给叔叔报仇！")
	for i, LootItemidx in x022005_g_LootItemList do
		CallScriptFunction( x022005_g_LootItemScript, "OnEnumerate",sceneId, selfId, targetId ,LootItemidx)
	end
...
function x022005_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i, LootItemidx in x022005_g_LootItemList do
		if eventId == x022005_g_LootItemScript then
...
function x022005_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	...
	local ret = 0
	for i, LootItemidx in x022005_g_LootItemList do
		if missionScriptId == x022005_g_LootItemScript then
