...
x400962_g_ScriptId = 400962; --脚本号
x400962_g_name	="车传仁";

--传送目标
x400962_g_transfer_target =
{
	[1] = {x = 120, z = 200, scene_num = 0}, 		--洛阳
	[2] = {x = 235, z = 156, scene_num = 1}, 		--苏州
	[3] = {x = 246, z = 106, scene_num = 2}, 		--大理
	[4] = {x = 294, z = 90, scene_num = 186}, 	--楼兰
	[5] = {x = 206, z = 266, scene_num = 34}, 	--南海
	[6] = {x = 186, z = 43, scene_num = 28},		--南诏
}

-- 收费金额
x400962_g_transfer_cost = 5000; -- 50银交子
...
function x400962_UpdateEventList( sceneId, selfId, targetId )
	BeginEvent(sceneId);
		...
		AddNumText(sceneId, x400962_g_ScriptId, "洛阳", 9, 1);
		AddNumText(sceneId, x400962_g_ScriptId, "苏州", 9, 2);
		AddNumText(sceneId, x400962_g_ScriptId, "大理", 9, 3);
		AddNumText(sceneId, x400962_g_ScriptId, "楼兰", 9, 4);
		AddNumText(sceneId, x400962_g_ScriptId, "南海", 9, 5);
		AddNumText(sceneId, x400962_g_ScriptId, "南诏", 9, 6);
	EndEvent()
...
function x400962_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if id >=1 and id <= 6 then
		BeginEvent(sceneId)
			...
			if id == 1 then	
				AddNumText(sceneId, x400962_g_ScriptId, "确定", 0, 11);
			elseif id == 2 then
				AddNumText(sceneId, x400962_g_ScriptId, "确定", 0, 21);
			elseif id == 3 then
				AddNumText(sceneId, x400962_g_ScriptId, "确定", 0, 31);
			elseif id == 4 then
				AddNumText(sceneId, x400962_g_ScriptId, "确定", 0, 41);
			elseif id == 5 then
				AddNumText(sceneId, x400962_g_ScriptId, "确定", 0, 51);
			elseif id == 6 then
				AddNumText(sceneId, x400962_g_ScriptId, "确定", 0, 61);
			end
			AddNumText(sceneId, x400962_g_ScriptId, "取消", 0, 100);
		EndEvent()
		DispatchEventList(sceneId, selfId, targetId);
	elseif id == 100 then
