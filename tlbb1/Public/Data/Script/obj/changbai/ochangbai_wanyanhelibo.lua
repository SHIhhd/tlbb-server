...
x022008_g_LootItemscript = 006667
x022008_g_LootItemList = {1030100}
--**********************************
--事件列表
--**********************************
function x022008_UpdateEventList( sceneId, selfId,targetId )
	...
	for i, LootItemidx in x022008_g_LootItemList do
		CallScriptFunction( x022008_g_LootItemscript, "OnEnumerate",sceneId, selfId, targetId ,LootItemidx)
	end
...
function x022008_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i, LootItemidx in x022008_g_LootItemList do
		if eventId == x022008_g_LootItemscript then
...
function x022008_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	...
	local ret = 0
	for i, LootItemidx in x022008_g_LootItemList do
		if missionScriptId == x022008_g_LootItemscript then
