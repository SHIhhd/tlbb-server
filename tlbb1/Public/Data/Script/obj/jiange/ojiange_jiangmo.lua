...
x007004_g_KillMonsterScript = 006666
x007004_g_KillMonsterList = {1000010,1000011,1000012}
--**********************************
--事件列表
--**********************************
function x007004_UpdateEventList( sceneId, selfId,targetId )
	...
	for i,KillMonsteridx in x007004_g_KillMonsterList do
		CallScriptFunction( x007004_g_KillMonsterScript, "OnEnumerate",sceneId, selfId, targetId,KillMonsteridx)
	end
...
function x007004_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i,KillMonsteridx in x007004_g_KillMonsterList do
		if eventId == x007004_g_KillMonsterScript then
...
function x007004_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i,KillMonsteridx in x007004_g_KillMonsterList do
		if missionScriptId == x007004_g_KillMonsterScript then
