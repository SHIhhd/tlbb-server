...
-- 收费金额
x400957_g_transfer_cost = 5000; -- 50银交子
...
function x400957_UpdateEventList( sceneId, selfId, targetId )
	BeginEvent(sceneId);
		...
		AddNumText(sceneId, x400957_g_ScriptId, "洛阳", 9, 1);
		AddNumText(sceneId, x400957_g_ScriptId, "大理", 9, 2);
		AddNumText(sceneId, x400957_g_ScriptId, "楼兰", 9, 3);
		AddNumText(sceneId, x400957_g_ScriptId, "南海", 9, 4);
		AddNumText(sceneId, x400957_g_ScriptId, "南诏", 9, 5);
		AddNumText(sceneId, x400957_g_ScriptId, "长白山", 9, 6);
	EndEvent()
...
function x400957_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if id >=1 and id <= 6 then
		BeginEvent(sceneId)
			...
			if id == 1 then	
				AddNumText(sceneId, x400957_g_ScriptId, "确定", 0, 11);
			elseif id == 2 then
				AddNumText(sceneId, x400957_g_ScriptId, "确定", 0, 21);
			elseif id == 3 then
				AddNumText(sceneId, x400957_g_ScriptId, "确定", 0, 31);
			elseif id == 4 then
				AddNumText(sceneId, x400957_g_ScriptId, "确定", 0, 41);
			elseif id == 5 then
				AddNumText(sceneId, x400957_g_ScriptId, "确定", 0, 51);
			elseif id == 6 then
				AddNumText(sceneId, x400957_g_ScriptId, "确定", 0, 61);
			end
			AddNumText(sceneId, x400957_g_ScriptId, "取消", 0, 100);
		EndEvent()
		DispatchEventList(sceneId, selfId, targetId);
	elseif id == 100 then
