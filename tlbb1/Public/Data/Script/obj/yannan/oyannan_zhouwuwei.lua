...
x018005_g_KillMonsterScript = 006666
x018005_g_KillMonsterList = {1000050,1000051,1000054}
--**********************************
--事件列表
--**********************************
function x018005_UpdateEventList( sceneId, selfId,targetId )
	...
	for i,KillMonsteridx in x018005_g_KillMonsterList do
		CallScriptFunction( x018005_g_KillMonsterScript, "OnEnumerate",sceneId, selfId, targetId,KillMonsteridx)
	end
...
function x018005_OnEventRequest( sceneId, selfId, targetId, eventId )
	for i,KillMonsteridx in x018005_g_KillMonsterList do
		if eventId == x018005_g_KillMonsterScript then
...
function x018005_OnMissionAccept( sceneId, selfId, targetId, missionScriptId )
	local ret = 0
	for i,KillMonsteridx in x018005_g_KillMonsterList do
		if missionScriptId == x018005_g_KillMonsterScript then
